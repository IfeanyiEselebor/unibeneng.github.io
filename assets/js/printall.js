$(document).ready(function() {
    mat_no = sessionStorage.getItem("mat_no");
     ...
     $.getJSON('https://unibencoursereg.000webhostapp.com/get_db.php', function(json) {
        ...
        mat_no = students_info['MAT_NO'];
        img_filename = students_info['img_filename'];
        $("#td_courses1").html(strCourses1);
        $("#td_courses2").html(strCourses2);
        $("#td_matno").html(mat_no);
        $("#td_surname").html(students_info['SURNAME']);
        $("#td_firstname").html(students_info['FIRSTNAME']);
        $("#td_othernames").html(students_info['OTHERNAMES']);
        $("#td_department").html(students_info['DEPT_ID']);
        $("#td_mode").html(students_info['MODE_OF_ENTRY']);
        $("#td_level").html(students_info['LEVEL']);
        $("#td_session").html(students_info['SESSION']);
        $("#td_phone").html(students_info['PHONE']);
        $("#td_gender").html(students_info['GENDER']);
        $("#td_total1").html(`Total - ${students_info['first_course_unit']}`);
        $("#td_total2").html(`Total - ${students_info['second_course_unit']}`);
...
function finalSubmit(){
    $.ajax({
        ...
        url: "https://unibencoursereg.000webhostapp.com/submitcoursereg.php",
        data: JSON.stringify({'mat_no': mat_no}),
        cache: false,
...
function doPrintPDF() {
    ...
    // Header
    let strH = "UNIVERSITY OF BENIN, BENIN CITY";
    ...
    //low performance
    var image = new Image();
    image.src = students_info["img_content"];
    pdf.addImage(image, pageWidth-160, startHeight-fontSize, 100, 100);
